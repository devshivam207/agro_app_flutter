    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          Container(
            padding: EdgeInsets.fromLTRB(Dimensions.width_15, 0, Dimensions.width_15, 0),
                              ...
                              children: [
                                ...
                                Container(
                                  ...
                                  decoration: BoxDecoration(
                                    borderRadius: BorderRadius.circular(Dimensions.circularradius20,)
                                  ),
                                  child: Image.network(recommendedprod
